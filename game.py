...
def mainGame():
    ...
    global run, validMove, game_over, board, graphical_board, board_positions_x, board_positions_y, X, O, X_WIN, O_WIN
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if checkWinner(board) != None:
                    game_over = True
                if quitButton.onClickButton(pygame.mouse.get_pos()):
                    run = False
                pygame.display.update()
